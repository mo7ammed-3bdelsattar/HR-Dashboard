...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->enum('role', ['super_admin', 'company_admin'])->default('super_admin')->after('password');
    ...
    public function down(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->dropColumn(['company_id', 'role', 'is_active', 'last_login_at', 'avatar', 'phone', 'deleted_at']);
        });
    }
};
